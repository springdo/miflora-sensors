...
# bedroompi [k]
nohup ./forever.sh C4:7C:8D:6C:59:DC 6011 >> exporter.log &

# babyroompi [E / F / I]
nohup ./forever.sh C4:7C:8D:6C:3E:06 6020 >> /dev/null &
nohup ./forever.sh C4:7C:8D:6C:3E:76 6021 >> /dev/null &
nohup ./forever.sh C4:7C:8D:6C:53:33 6022 >> /dev/null &

# spareroompi [H / J]
nohup ./forever.sh C4:7C:8D:6C:57:CE 6030 >> exporter.log &
nohup ./forever.sh C4:7C:8D:6C:56:E5 6031 >> exporter.log &
